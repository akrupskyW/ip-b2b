...
commit day. Feeds the Codebase score cards on pages/all-modules.html.

All Modules also live-crawls the same file types once a day (Re-evaluate)
...
def main():
    ...
    header = (
        ...
        " * plus today's working tree as the latest series point.\n"
