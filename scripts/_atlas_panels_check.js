...
const sandbox = {
  ...
  campaignOohReply: () => '',
  campaignPrintReply: () => '',
  campaignLookbookReply: () => '',
  campaignCardsReply: () => '',
  campaignTeaserReply: () => '',
  WISE_CAMPAIGN_BRIEF: 'Generate a marketing campaign',
  thinkWiseReply: () => '',
  thinkWiseCastReply: () => '',
  thinkWiseBillboardsReply: () => '',
  thinkWiseMoldsReply: () => '',
  thinkWiseWalkReply: () => '',
  thinkWiseFilmReply: () => '',
  THINK_WISE_BRIEF: 'The Wise Walk campaign',
  clothingReply: () => '',
  clothingKidsReply: () => '',
  clothingAccessoriesReply: () => '',
  clothingGraphicReply: () => '',
  clothingSwimReply: () => '',
  clothingEverydayReply: () => '',
  clothingFormalReply: () => '',
  FOOD_TRUTH_LINE_BRIEF: 'Create a clothing line',
