...
(function (global) {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '.wch-ask-group-title{display:flex;align-items:center;gap:8px;padding:4px 6px 8px;font-family:"WISE Digits","Noto Serif",serif;font-size:1.12rem;font-weight:800;letter-spacing:-.01em;line-height:1.2;color:var(--text);}',
      ...
      '.wch-ask-panel .wch-head-title{font-family:"WISE Digits","Noto Serif",serif;font-weight:800;font-size:1.2rem;letter-spacing:-.01em;line-height:1.16;}',
