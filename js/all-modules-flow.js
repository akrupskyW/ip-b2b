...
function moduleStyles() {
  return `<style id="mi-styles">
    ...
    .dsc-demo .sc-reply-chips .chip--match .material-symbols-outlined { color: var(--primary) !important; }
      ...
      <header class="mi-hero">
        <div class="mi-hero-text">
          ...
          <p class="mi-hero-lede">An admin index of every module in the WISE app, plus the Icon Inventory,
            the Design System (fonts, type scale, and every color token), and the Component Library —
            every reusable component rendered live in its default state, with where it's used. Use it as a
            design-system map and a jumping-off point to any screen.</p>
        </div>
...
export const ALL_MODULES_WISEAI = {
  sub: 'Your app’s module map, icon inventory, design system and component library.',
  chipsFlow: 'wrap',
  intents: [
