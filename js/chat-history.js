...
(function (global) {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '.wch-chat-dot.wch-live-dot::after{border:2px solid color-mix(in srgb,var(--helix-ink,#25507C) 26%,transparent);border-top-color:var(--helix-ink,#25507C);animation:wchSpin .8s linear infinite;}',
