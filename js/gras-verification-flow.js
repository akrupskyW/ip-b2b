...
export const GRAS_WISEAI = {
  ...
  intents: [
    ...
    { intent: 'autofill_docs', label: 'Attach & fill the documents', icon: 'upload_file' },
    { intent: 'next_step', label: 'Continue to the next step', icon: 'arrow_forward' },
    { intent: 'sign_attestation', label: 'Sign the attestation', icon: 'verified_user' },
    { intent: 'submit_gras', label: 'Submit for review', icon: 'send' },
    { intent: 'run_review', label: 'Run the WISEcode review', icon: 'rule' },
    { intent: 'view_submissions', label: 'Open the review queue', icon: 'assignment_turned_in' },
    { intent: 'verify_another', label: 'Verify another ingredient', icon: 'restart_alt' },
    { intent: 'explain_gras', label: 'What is GRAS verification?', icon: 'help_outline' },
    { intent: 'doc_pathways', label: 'Which pathway do I need?', icon: 'category' },
    { intent: 'what_clears', label: 'What will this clear?', icon: 'inventory_2' },
  ],
  intentReplies: {
