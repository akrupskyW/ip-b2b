...
export const MODULE_SECTIONS = [
  ...
  },
  {
    ...
    tone: 'reform',
    modules: [
      { label: 'Reformulation Overview', icon: 'auto_fix_high', href: 'reformulation.html' },
  ...
  },
  {
    ...
    modules: [
      ...
      { label: 'App', icon: 'barcode_scanner', href: '../marketing-app.html' },
      { label: 'Coach', icon: 'bolt', href: '../marketing-coach.html' },
