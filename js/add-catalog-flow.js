...
(function () {
  ...
  function addUserFile(name) {
    hideWelcome();
    messagesEl.insertAdjacentHTML('beforeend',
      `<div class="sc-line sc-line-you">${youAvatarSpan()}<div class="sc-line-body">${esc(name || 'File')}<div class="ap-file-chip"><span class="material-symbols-outlined">${fileIconFor(name)}</span><span>${esc(name || 'File')}</span></div><div class="sc-line-meta"><span class="sc-line-time">${esc(nowLabel())}</span></div></div></div>`);
    scrollDown(true);
  }
  ...
  function showTyping() {
    ...
    el.innerHTML = `<span class="sc-avatar sc-avatar-wiseai" role="img" aria-label="WISEcodeAI">${owlBug()}</span><div class="sc-line-body"><span class="sc-typing-status"><span class="sc-typing-spin" aria-hidden="true"></span><span class="sc-typing-label">WISEcodeAI is thinking…</span></span></div>`;
