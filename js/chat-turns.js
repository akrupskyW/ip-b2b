...
(function (global) {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '.wt-fork{display:inline-flex;align-items:center;justify-content:center;width:30px;height:30px;border:0;border-radius:8px;background:transparent;color:var(--primary-ink,var(--primary,#2F6DF6));cursor:pointer;opacity:.9;transition:background .14s ease,color .14s ease,opacity .14s ease;}',
      ...
      '.wt-fork-id{font-size:11px;font-weight:700;letter-spacing:0.02em;color:var(--primary-ink,var(--primary,#2F6DF6));font-variant-numeric:tabular-nums;margin:0 2px 0 -1px;}',
