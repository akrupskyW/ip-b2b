...
import { decorateWhootie } from './whootie-tooltip.js';
    ...
    <div class="chat-topbar">
      <div class="sc-topbar-lead">
        ...
        <div class="sc-topbar-titles">
          <span class="topbar-title" data-whootie-tip tabindex="0">${esc(title)}</span>
