...
(function () {
  ...
  function ensureStyles() {
    ...
    var css = ''
      ...
      + '.ct-head-ic{flex:0 0 auto;font-size:20px;color:var(--primary,#25507c);'
      ...
      + '.ct-fb-btn.is-on{color:var(--primary,#25507c);}'
      ...
      + '.ct-fb-reason.is-on{border-color:var(--primary,#25507c);color:var(--primary,#25507c);'
